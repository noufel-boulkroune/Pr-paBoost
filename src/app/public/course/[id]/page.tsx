...
const DEFAULT_AVATAR = undefined; // Avatar component handles this internally
                  ...
                  <div className="flex items-baseline gap-3">
                    ...
                    {course.compareAtPrice && (
                      <span className="text-body-lg text-text-muted line-through">
                        {formatPrice(course.compareAtPrice || 0, course.currency || "USD")}
                      </span>
                    )}
                  </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-6 mt-4">
                          ...
                          {course.instructor?.rating !== undefined && course.instructor.rating > 0 && (
                            <div className="text-center">
                              <div className="text-heading-md font-bold text-text-primary">
